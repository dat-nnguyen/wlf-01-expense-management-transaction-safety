...
from packages.data.schemas.transaction import Transaction, TransactionDirection, TransactionSource
...
class ReconciliationEngine:
    ...
    def reconcile_sources(
        ...
        # 1. Account ↔ Wallet Reconciliation
        ...
        for c_tx in card_txs:
            ...
            if best_score < 0.30 and c_tx.amount >= 50.0:
                alerts.append(
                    Alert(
